...
@pytest.mark.asyncio()
async def test_sort_ascending(paginator, sample_users):
...
@pytest.mark.asyncio
async def test_sort_descending(paginator, sample_users):
...
@pytest.mark.asyncio
async def test_sort_and_filter(paginator, sample_users):
...
@pytest.mark.asyncio
async def test_sort_with_pagination(paginator, sample_users):
